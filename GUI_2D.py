...
def graph_plot():
    ...
    plt.clf()
    x_vals = np.linspace(0.2 * a, 2 * a, 1000)
    ...
    plt.legend()
    plt.title('$F_{res}$ vs ($\lambda$/a) (2-D)', fontsize=15)
...
a_options = [1.0]
lambda_options = [0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.707, 0.75, 0.8, 0.85, 0.9, 0.95, 1]
...
tk.Label(input_frame, text='Displacement ratio (λ = x/a) :', font=("helv15", 14)).grid(row=2, column=0, sticky='w')
